...
local messages = {
    ["en"] = {
        ...
        confirm = "All right. I sense a strong sense of duty in you. Know that we only exist to protect the main family. Knowing that, are you really sure you want to {join} us?",
    ...
    ["pt"] = {
        ...
        confirm = "Tudo bem. Sinto um forte senso de dever em você. Saiba que existimos apenas para proteger a família principal. Sabendo disso, você realmente quer {fazer parte} do nosso clã?",
