...
-- Storage >= 1: Aprendeu Naruto Rendan
-- Storage >= 2: Aprendeu Kyuubi no Chakra
-- Storage >= 3: Aprendeu Oodama Rasengan
-- Storage >= 4: Aprendeu Rasenshuriken
...
local messages = {
    ["en"] = {
        ...
        noLvl = "Hah, don't ever think becoming a Uzumaki member with this level. First of all, get level 5 to join us!",
        ...
        done = "Great! Now you are a member of the Uzumaki clan! Lets work together to achieve greatness! I trust that one of us will, one day, be the hokage of our village! Ah, I almost forgot. Let me teach you {Kage Bunshin no Jutsu}! It's a jutsu to make copies of yourself. Use it well!",
        ...
        noLvlQuest2 = "Hey |PLAYERNAME|! I get that you want to learn some new tricks, but see, you need to be a bit more stronger to learn more techniques from me. Let's do this: Get level 80 and I will teach you something nice, okay?",
        quest2 = "So here comes our rising start! I see you've done what I asked for! Ok, so let's teach you a skill named {Kyuubi no Chakra}! It's a buff technique that will increase your general abilities, so you can move faster, hit harder and take less damage! So, let's {learn Kyuubi no Chakra}?",
        ...
        quest2Done = "Such talent! If turning into a Hokage was done using eletronical urns, I could consider voting in you! Now I doubth anything would be a problem for you! Let's continue training and getting stronger!",

        noLvlQuest3 = "See, I know I told you to get stronger so I can teach you more techniques, but see, you need to be like, a LOT STRONGER! Level 100 is enought for the next jutsu, ok? Don't worry, I'll be right here waiting for you!",
        quest3 = "NOW THIS IS WHAT I TALKED ABOUT! I can say for sure you are ready to learn {Oodama Rasengan} from me! This is a powerfull technique that materialize your chakra in your palm in a sphere form, but it is like, REALLY BIG! It's not easy to master it, y'know? So, are you ready to {learn Oodama Rasengan}?",
        quest3Requirements = "So let's start your training. Bring me {one ryo} and I will teach you Chidori.",
        quest3Incomplete = "You don't have {one ryo} with you. Come back when you do, and I will teach you Chidori.",
        quest3Done = "Are you sure you aren't like a genius or something? That was not an easy technique, and you still mastered it like it was nothing! But that was the minimum I expect for you! Don't let this get to your head tho. Continue training and getting stronger!",

        noLvlQuest4 = "Eager to learn more, hm? I don't mind it at all! I love to see my students getting stronger! I turned into a teacher because of that! BUUUUUUUUT... yeah... You know it, right? I need you to get a bit more stronger for this next technique, because boy oh boy, this jutsu will be a BLAST! Let's talk again when you're around level 120, kay?",
        quest4 = "So there's our (maybe) future Hokage! I see that you're confident, and I definitely sensed your chakra when you entered the village. You are now ready to learn {Rasenshuriken}! This is like Oodama Rasengan, but smaller... AND MUCH STRONGER! Confused, right? It's because this jutsu has a element inbuided it, turning it extremely destructive AND hard to control. But I'm sure you can handle it! Ready to {learn Rasenshuriken}?",
        quest4Requirements = "So let's start your training. Bring me {one ryo} and I will teach you Chidori.",
        quest4Incomplete = "You don't have {one ryo} with you. Come back when you do, and I will teach you Chidori.",
        quest4Done = "That... was... AWESOME! You surpassed yourself and learned to control Rasenshuriken! Just be careful with it, ok? Try to not use it inside village. When I was learning it I destroyed some houses and the villagers were not happy with me... BUT ANYWAY! Continue training and getting stronger! You are one of the most powerful member in our clan right now, but there's always room to be better!",
    ...
    ["pt"] = {
        ...
        noLvl = "Opa! Nem pense em se tornar um membro do clã Uzumaki com esse nível. Primeiro, alcance o nível 5 para se juntar a nós!",
        ...
        noLvlQuest1 = "Hey |PLAYERNAME|! Desculpe, mas não posso te ensinar nada agora. Pode voltar para mim quando você estiver pelo menos no nível 50? Beleza! Estarei te esperando!",
        ...
        noLvlQuest2 = "Hey |PLAYERNAME|! Eu entendo que você quer aprender alguns truques novos, mas veja, você precisa ser um pouco mais forte para aprender mais técnicas comigo. Vamos fazer o seguinte: Chegue ao nível 80 e eu te ensinarei algo legal, ok?",
        ...
        noLvlQuest3 = "Olha só, eu sei que te disse para ficar mais forte para que eu possa te ensinar mais técnicas, mas veja, você precisa ser MUITO MAIS FORTE! Nível 100 é suficiente para o próximo jutsu, ok? Não se preocupe, estarei bem aqui te esperando!",
        ...
        noLvlQuest4 = "Sempre querendo aprender mais, em? Eu não me importo nem um pouco! Adoro ver meus alunos ficando mais fortes! Eu me tornei um professor por causa disso! MAAAAAAS... sim... Você sabe, certo? Preciso que você fique um pouco mais forte para essa próxima técnica, porque rapaz, esse jutsu vai ser uma EXPLOSÃO! Vamos conversar novamente quando você estiver por volta do nível 120, beleza?",
...
local validWords = {
    ["pt"] = {"ajudar", "haruno", "tornar", "fazer parte", "traz", "aprender naruto rendan", "aprender kyuubi no chakra", "aprender oodama rasengan", "aprender rasenshuriken"},
    ["en"] = {"help", "haruno", "become", "join", "brings", "learn naruto rendan", "learn kyuubi no chakra", "learn oodama rasengan", "learn rasenshuriken"}
}
...
local function creatureSayCallback(cid, type, msg)
    ...
    if msgcontains(msgLower, "uzumaki") then
        ...
        elseif playerVocation == narutoVocationId then
            ...
            npcHandler:say(messages[currentLang].askUzumaki, cid)
