...
local messages = {
    ...
    ["pt"] = {
        ...
        quest4Done = "Você conseguiu. Eu não achei que você tivesse isso em você, mas você realmente fez. Vou te ensinar Amaterasu agora, mas lembre-se que tal poder pode ser uma espada de dois gumes.",
    }
}
...
local function creatureSayCallback(cid, type, msg)
    ...
    if msgcontains(msgLower, "brings") or msgcontains(msgLower, "traz") then
        ...
        elseif uchihaJutsu == 3 then
            ...
            npcHandler:say("You have mastered all the techniques I can teach you for now. There is nothing more for me to offer.", cid)
        end
        return true
    end
